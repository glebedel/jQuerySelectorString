...
$.extend($, {
    SelectorString: {
         ...
         */
        addExcludedClass: function addExcludedClass(classes) {
            if (typeof classes !== "string") this.excludedClasses.concat(classes);else this.excludedClasses.push(classes);
        },
        /**
         ...
         */
        removeExcludedClass: function removeExcludedClass(classString) {
...
$.fn.extend({
     ...
     */
    getPath: function getPath(useClasses) {
        useClasses = useClasses || $.SelectorString.useClasses;
        useIDs = useIDs || $.SelectorString.useIDs;
        var path,
            node = this;
     ...
     */
    getSelectorToParent: function getSelectorToParent(parent, useClasses) {
